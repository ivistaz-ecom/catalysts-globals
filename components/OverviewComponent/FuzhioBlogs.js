        ...
        <h2 className="md:text-[32px] text-[22px] bg-[#BAD46F]  p-1  ">Impact Product Marketing Firm</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
            <div>
              ...
              <br />
              <br />
              <h2 className="md:text-[32px] text-[22px] bg-[#BAD46F]  p-1 inline-block ">Impacts:</h2><br /><br />
              ...
              <br />
              <h2 className="md:text-[32px] text-[22px] bg-[#BAD46F]  p-1 inline-block ">Agriculture Products:</h2><br /><br />
              <ul className="list-disc pl-5">
